            ...
            <div class="menu-space">
                <div class="content">
                    ...
                    <ul class="cl-vnavigation">
                        ...
                        <li><a href="showAllNoticeToStu.action">公告</a></li>
                        <li><a href="showAllSignUpInfoToStu.action">查看可报名考试</a></li>
                        <li><a href="#" onclick="document.getElementById('StuQueryExam').submit()">已报名考试</a></li>

                        <li><a href="">准考证打印</a></li>
                        <form action="showSignUpExamToStu.action" method="post" id="StuQueryExam">
