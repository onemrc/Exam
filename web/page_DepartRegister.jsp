...
<div id="cl-wrapper" class="sign-up-container">
    ...
    <div class="middle-sign-up">
        <div class="block-flat">
            ...
            <div>
                <form style="margin-bottom: 0px !important;" class="form-horizontal" action="departmentRegister.action" >
                    <div class="content">
                        <h5 class="title text-center"><strong>组织部门人员注册</strong></h5>
                        <hr>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="departmentEntity.departStaffName" parsley-trigger="change" parsley-error-container="#nick-error" required="" placeholder="姓名" class="form-control">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="departmentEntity.departEmail" parsley-trigger="change" parsley-error-container="#email-error" required="" placeholder="E-mail" class="form-control">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                    <input type="text" name="departmentEntity.departJobNum" parsley-trigger="change"  required="" placeholder="工号" class="form-control">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                    <input type="text" name="departmentEntity.departUnit" parsley-trigger="change" parsley-error-container="#input-error" required="" placeholder="工作单位" class="form-control">
                                </div>
                            </div>
                        </div>
