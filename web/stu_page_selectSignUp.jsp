                                ...
                                <table class="table table-bordered dataTable" id="datatable-icons"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0"
                                            aria-controls="datatable-icons" rowspan="1" colspan="1"
                                            aria-label="Platform(s): activate to sort column ascending"
                                            style="width: 150px;">报名发布时间
                                        </th>
                                        <th class="sorting" role="columnheader" tabindex="0"
                                            aria-controls="datatable-icons" rowspan="1" colspan="1"
                                            aria-label="Platform(s): activate to sort column ascending"
                                            style="width: 150px;">报名开始时间
                                        </th>
                                        <th class="sorting" role="columnheader" tabindex="0"
                                            aria-controls="datatable-icons" rowspan="1" colspan="1"
                                            aria-label="Platform(s): activate to sort column ascending"
                                            style="width: 150px;">报名结束时间
                                        </th>
                                        <th class="sorting" role="columnheader" tabindex="0"
                                            aria-controls="datatable-icons" rowspan="1" colspan="1"
                                    ...
                                    <s:iterator id="AllSignUp" value="#request['SignUp']">
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                        <tr class="gradeA even">
                                            <td class="  sorting_1"><s:property value="#AllSignUp.signUpId"/> </td>
                                            <td class=" "><s:property value="#AllSignUp.examName"/></td>
                                            <td class=" "><s:property value="#AllSignUp.examTime"/></td>
                                            <td class=" "><s:property value="#AllSignUp.examPlace"/></td>
                                            <td class=" "><s:property value="#AllSignUp.signUpPutTime"/></td>

                                            <td class="  "><s:property value="#AllSignUp.signUpStartTime"/></td>
                                            <td class="  "><s:property value="#AllSignUp.signUpEndTime"/></td>

                                            <form action="stuSeleteSignUp.action" method="post" id="sign">
                                                <input type="hidden" name="studentsignupEntity.signUpId" value="<s:property value="#AllSignUp.signUpId"/>">
                                                <input type="hidden" name="studentsignupEntity.stuId" value="${sessionScope.user.stuId}">
                                            </form>
                                            <td class="center "><a class="btn btn-primary btn-xs" href="#"
                                                                   data-original-title="报名"
                                                                   data-toggle="tooltip"
                                                                   onclick="document.getElementById('sign').submit()"><i
