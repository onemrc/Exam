...
<s:iterator id="allRegDepart" value="#request['AllRegDepart']">
                                        ...
                                        <tr class="gradeA even">
                                            <td class="  sorting_1"><s:property value="#allRegDepart.departId"/></td>
                                            <td class=" "><s:property value="#allRegDepart.departStaffName"/></td>
                                            <td class=" "><s:property value="#allRegDepart.departJobNum"/></td>
                                            <td class="center "><s:property value="#allRegDepart.departUnit"/> </td>
                                            <td class="center "><s:property value="#allRegDepart.departEmail"/> </td>

                                            <form action="deleteDepart.action" method="post" id="delete">
                                            ...
                                            <td class="center "><a class="btn btn-primary btn-xs" href="#"
                                                                   data-original-title="Edit" data-toggle="tooltip"><i
                                                    class="fa fa-pencil"></i></a> <a class="btn btn-danger btn-xs"
                                                                                     href="#"
                                                                                     data-original-title="Remove"
                                                                                     data-toggle="tooltip"><i
                                                    class="fa fa-times" onclick="document.getElementById('delete').submit();"></i></a></td>
                                        </tr>
                                        </tbody>
</s:iterator>
                                    </table>
