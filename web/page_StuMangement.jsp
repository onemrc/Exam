...
<s:iterator id="allRegStu" value="#request['AllRegStu']">
    ...
    <td class=" sorting_1"><s:property value="#allRegStu.stuId"/></td>
    <td class=" "><s:property value="#allRegStu.stuName"/></td>
    <td class=" "><s:property value="#allRegStu.stuIdNum"/></td>
    <td class="center "><s:property value="#allRegStu.stuPhone"/></td>
    <td class="center "><s:property value="#allRegStu.stuEmail"/></td>

    <form action="deleteStu.action" method="post" id="delete">
