                        ...
                        <div class="table-responsive">
                            <div id="datatable-icons_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <table class="table table-bordered dataTable" id="datatable-icons"
                                    ...
                                    <s:iterator id="SignUpHaveStu" value="#request['Stu']">
                                    <tr class="gradeA even">
                                        <td class="  sorting_1"><s:property value="#SignUpHaveStu.stuId"/> </td>
                                        <td class=" "><s:property value="#SignUpHaveStu.stuName"/></td>
                                        <td class=" "><s:property value="#SignUpHaveStu.stuIdNum"/></td>
                                        <td class="center "><s:property value="#SignUpHaveStu.signUpPutTime"/></td>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="pull-left">
                                            <div class="dataTables_info" id="datatable-icons_info">Showing 1 to 10 of 57
                                                entries
                                            </div>
                                        </div>
                                        <div class="pull-right">
